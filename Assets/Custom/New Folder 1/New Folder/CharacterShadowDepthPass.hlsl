...
#include "Packages/com.unity.tooncharactershadow/Shaders/CharacterShadowTransforms.hlsl"
...
float CharShadowFragment(Varyings input) : SV_TARGET
{
    ...
    float alphaClipVar = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, input.uv).a;
